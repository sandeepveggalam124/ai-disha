...
const RoleManagement = () => {
  ...
  return (
    <div>
      ...
      >
        <Box gridColumn="span 12" sx={{ marginTop: "auto", textAlign: "left" ,marginBottom:'20px'}}>
          <Typography
        ...
        <Box gridColumn="span 3" sx={{ marginTop: "auto", textAlign: "left" }}>
          ...
          <CssTextField label="Role Name" id="custom-css-outlined-input" size="small" sx={{width:"95%"}} />
